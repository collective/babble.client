jQuery(function ($) {
	$.fn.quicksearch = function (opt) {
		...
		function make_form_input() {
			...
			return '<input type="text" title="Filter" value="' + val + '" rel="' + options.randomElement  + '" class="inputLabel inputLabelActive ' + options.inputClass + '" id="' + options.randomElement + '" /> ';
		}
		...
		function make_form() {
			...
			return '<' + f + ' action="#" ' + 'id="'+ options.formId + '" ' + 'class="quicksearch">' +
                    make_form_input() + make_form_loader() + '</' + f + '>';
		}
